function ConveyerBelt(sketch, inPosX)
{
  ...
  this.posX = inPosX;
  this.posY = sketch.height/2 + sketch.height/5;
  ...
  this.update = function()
  {
    ...
    {
      if(this.ctr == 0)
        sketch.image(this.conveyer1, this.posX, this.posY, this.conveyer1.width/this.shrinkFactor, this.conveyer1.height/this.shrinkFactor);
      if(this.ctr == 1)
      ...
      if(this.ctr == 2)
        sketch.image(this.conveyer3, this.posX, this.posY, this.conveyer3.width/this.shrinkFactor, this.conveyer3.height/this.shrinkFactor);
    }
